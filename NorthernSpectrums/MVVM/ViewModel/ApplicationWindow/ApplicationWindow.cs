...
namespace NorthernSpectrums.MVVM.ViewModel.ApplicationWindow
{
    /// <summary>
    /// <c>Class</c> The Application Window Class. Replaces the standard WPF window with a fully customizable window.
    /// </summary>
